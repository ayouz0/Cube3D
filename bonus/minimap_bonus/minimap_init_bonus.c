...
/*   Updated: 2025/05/18 20:36:34 by aaitabde         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_minimap(t_game *game)
{
	...
	game->minimap.width = game->minimap.view_range \
	* 2 * game->minimap.cell_size;
	game->minimap.height = game->minimap.view_range \
	* 2 * game->minimap.cell_size;
